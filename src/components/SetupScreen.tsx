...
export default function SetupScreen() {
    ...
    return (
        <div className="min-h-screen bg-slate-800 text-slate-100 flex flex-col items-center justify-center p-4 sm:p-6 font-sans">
            ...
            <div className="w-full max-w-xl space-y-4">
                <textarea
                    ...
                    className="w-full h-40 sm:h-48 bg-slate-900 border border-slate-700 rounded-2xl sm:rounded-3xl p-4 sm:p-5 font-mono text-xs sm:text-sm text-slate-200 focus:border-blue-500 outline-none shadow-inner"
                    placeholder={`{\n  apiKey: "AIzaSy...",\n  authDomain: "...",\n  projectId: "...",\n  appId: "..."\n}`}
                />
                {error && <p className="text-red-300 text-[10px] font-bold text-center bg-red-900/30 p-2 rounded-lg">{error}</p>}
